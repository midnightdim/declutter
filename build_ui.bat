pyside6-uic ui\rule_edit_window.ui > ui_rule_edit_window.py
REM pyside6-uic ui\test_window.ui > ui_test_window.py
...
pyside6-uic ui\settings_dialog.ui > ui_settings_dialog.py
pyside6-uic ui\tags_dialog.ui > ui_tags_dialog.py
